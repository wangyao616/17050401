var sweet_alert = {
    ...
    */
    ...
    'alertFail':function (msg,confirmCallback) {
        args = {
            'title': '提示',
            'text': msg,
            'type': 'error',
    ...
    */
    'alertConfirm':function (params) {
        swal({
            ...
            'confirmButtonColor':params['confirmColor'] ? params['confirmColor'] : '#AEDEF4',
            'cancelButtonText': params['cancelText'] ? params['cancelText'] : '取消',
            'text': params['text'] ? params['text'] : '确认删除吗？'
        },function (isConfirm) {
            if(isConfirm){
    ...
    */
    'alertNetworkError':function () {
        this.alertErrorToast('网络好像出错了呀~');
    },
    /*
        功能：服务器错误提示
        参数：无
    */
    'alertServiceError':function () {
        this.alertErrorToast('服务器好像出错了呀~');
    },
